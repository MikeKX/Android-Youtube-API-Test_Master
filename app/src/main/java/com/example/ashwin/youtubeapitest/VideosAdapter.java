...
public class VideosAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public VideosAdapter(VideoListener videoListener, List<Item> videos) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof VideoViewHolder) {
            ...
            String videoImageUrl = mVideos.get(position).getSnippet().getThumbnails().getMedium().getUrl();
            ...
            videoViewHolder.videoTextView.setText(mVideos.get(position).getSnippet().getTitle());
